...
- **Repo**: https://github.com/ExampleOwner/cofi
- **Owner**: ExampleOwner (transferred from ExampleOrg)
- **Default branch**: `develop`
- **Tracking**: Linear via `linearis`
- **Team**: `TFD` / `ExampleOrg` (`00000000-0000-0000-0000-000000000000`)
