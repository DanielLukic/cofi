...
int main() {
    ...
    TestCase tests[] = {
        ...
        {"mw+", "mw", "+", "Maximize compact on"},
        {"mw-", "mw", "-", "Maximize compact off"},
        {"max+", "mw", "+", "Maximize alias compact on"},
        {"hm+", "hmw", "+", "Horizontal maximize alias compact on"},
        {"hm-", "hmw", "-", "Horizontal maximize alias compact off"},
        {"hmw+", "hmw", "+", "Horizontal maximize primary compact on"},
        {"vm+", "vmw", "+", "Vertical maximize alias compact on"},
        {"vm-", "vmw", "-", "Vertical maximize alias compact off"},
        {"vmw+", "vmw", "+", "Vertical maximize primary compact on"},
