...
void test_basic_fuzzy_match() {
    ...
    struct {
        ...
        {"ddl", "Diana Drew Lane", 1, "ddl should match Diana Drew Lane (initials)"},
        {"dd", "Diana Drew", 1, "dd should match Diana Drew (initials)"},
...
void test_window_search() {
    ...
    WindowInfo test_windows[] = {
        ...
        {.desktop = 3, .instance = "terminal", .title = "user@laptop: ~", .class_name = "Gnome-terminal"},
    };
...
void test_scoring() {
    ...
    struct {
        ...
        {"ddl", "Diana Drew Lane", "ddl-config.txt", "Diana Drew Lane"},  // Initials bonus
