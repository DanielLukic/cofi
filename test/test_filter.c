...
void test_word_boundary_matching() {
    ...
    add_test_window(&app, create_test_window(3, "SampleApp Timer", "SampleApp", "sampleapp", "Normal", 0));
    ...
    // Test "comm" matches "SampleApp Timer"
    filter_windows(&app, "comm");
    ASSERT_EQ(app.filtered_count, 1, "Filter 'comm' should match 1 window");
    ASSERT_STR_EQ(app.filtered[0].title, "SampleApp Timer", "Should match 'SampleApp Timer'");
...
void test_initials_matching() {
    ...
    // Add test windows
    add_test_window(&app, create_test_window(1, "Visual Studio Code", "Code", "code", "Normal", 0));
    add_test_window(&app, create_test_window(2, "Diana Drew Lane", "Terminal", "gnome-terminal", "Normal", 0));
    ...
    // Test "ddl" matches "Diana Drew Lane"
    filter_windows(&app, "ddl");
    ASSERT_EQ(app.filtered_count, 1, "Filter 'ddl' should match 1 window");
    ASSERT_STR_EQ(app.filtered[0].title, "Diana Drew Lane", "Should match 'Diana Drew Lane' by initials");
