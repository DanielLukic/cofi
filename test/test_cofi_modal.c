...
static void test_enter_modal_sets_lifecycle_state(void) {
    ...
    ASSERT_TRUE("enter surfaces provider tab",
                app.current_tab == TAB_RUN && app.tab_visibility[TAB_RUN] == TAB_VIS_SURFACED);
...
static void test_exit_modal_restores_origin_and_hides_tab(void) {
    ...
    ASSERT_TRUE("exit hides modal tab", app.tab_visibility[TAB_RUN] == TAB_VIS_HIDDEN);
...
static void test_escape_nonempty_clears_only(void) {
    ...
    ASSERT_TRUE("esc nonempty stays on modal tab", app.current_tab == TAB_RUN);
...
static void test_escape_empty_exits_modal(void) {
    ...
    ASSERT_TRUE("esc empty hides tab", app.tab_visibility[TAB_RUN] == TAB_VIS_HIDDEN);
}
...
static void test_tab_exits_modal_and_allows_tab_cycle(void) {
    ...
    ASSERT_TRUE("tab hides modal tab", app.tab_visibility[TAB_RUN] == TAB_VIS_HIDDEN);
}
