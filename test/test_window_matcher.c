...
void test_titles_match_fuzzy() {
    ...
    assert(titles_match_fuzzy("SampleApp", "SampleApp Timer") == true);
    assert(titles_match_fuzzy("Timer - SampleApp", "SampleApp") == true);
...
void test_sampleapp_case() {
    printf("Testing SampleApp specific case...\n");
    
    WindowInfo stored = create_test_window(0x640000c, "SampleApp", "SampleApp", "sampleapp", "Normal");
    WindowInfo current = create_test_window(0x3e0000c, "SampleApp", "SampleApp", "sampleapp", "Normal");
