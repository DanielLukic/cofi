...
static const CommandSpec s_core_commands[] = {
    ...
    },
    {
        ...
        .help_format = "hm, horizontal-maximize-window, hmw [toggle|on|off]",
        .activates = 1
    },
    {
        .primary = "jw",
    ...
    },
    {
        ...
        .help_format = "mw, max, maximize-window [toggle|on|off]",
        .activates = 1
    },
    {
        .primary = "pw",
    ...
    },
    {
        ...
        .owner_provider_id = COMMAND_OWNER_CORE,
        .handler = cmd_show,
        .description = "Show cofi in a specific mode (windows/command/run/workspaces/harpoon/matching/config/rules/apps/path/emoji/projects/files/calc/proc/sinks/sessions/profiles/bookmarks/bluetooth)",
    ...
    },
    {
        ...
        .help_format = "vm, vertical-maximize-window, vmw [toggle|on|off]",
        .activates = 1
    },
    {
        .primary = "help",
