...
SOURCES = src/main.c \
          ...
          src/agent_sessions.c \
          src/agent_sessions_provider.c \
...
test_hotkey_grab_state: test/test_hotkey_grab_state.c src/hotkey_grab_state.o src/app_init.o src/cofi_tab_provider.o
...
test_command_handlers_behavior: test/test_command_handlers_behavior.c src/command_handlers_window.o src/command_handlers_workspace.o src/command_handlers_tiling.o src/command_handlers_ui.o src/core_commands.o src/command_registry.o src/command_availability.o src/slot_store.o src/log.o
	$(CC) $(CFLAGS) -o test/test_command_handlers_behavior test/test_command_handlers_behavior.c src/command_handlers_window.o src/command_handlers_workspace.o src/command_handlers_tiling.o src/command_handlers_ui.o src/core_commands.o src/command_registry.o src/command_availability.o src/slot_store.o src/log.o $(LDFLAGS)
...
test_command_candidates: test/test_command_candidates.c test/command_handler_stubs.c src/cofi_tab_provider.o src/command_availability.o src/core_commands.o src/command_registry.o src/nav_keys.o src/tab_metadata.o src/tab_header.o
	$(CC) $(CFLAGS) -o test/test_command_candidates test/test_command_candidates.c test/command_handler_stubs.c src/cofi_tab_provider.o src/command_availability.o src/core_commands.o src/command_registry.o src/nav_keys.o src/tab_metadata.o src/tab_header.o $(LDFLAGS)
...
test_agent_sessions: test/test_agent_sessions.c src/agent_sessions.c src/fzf_algo.o src/log.o
	$(CC) $(CFLAGS) -DCOFI_TESTING -o test/test_agent_sessions test/test_agent_sessions.c src/agent_sessions.c src/fzf_algo.o src/log.o $(LDFLAGS)

test_agent_sessions_provider: test/test_agent_sessions_provider.c src/fzf_algo.o
	$(CC) $(CFLAGS) -DCOFI_TESTING -o test/test_agent_sessions_provider test/test_agent_sessions_provider.c src/fzf_algo.o $(LDFLAGS)
