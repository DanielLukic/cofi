...
- Providers can request dynamic tab handles. Profiles, Calc, Run, Sinks, Proc, Sessions, Apps, and Names use this
...
- Profiles, Calc, Run, Sinks, Proc, Sessions, Apps, and Names now use dynamic tab handles. Other existing provider
...
- Profiles, Calc, Run, Sinks, Proc, Sessions, Apps, and Names no longer have static `TAB_*` enum values and register
