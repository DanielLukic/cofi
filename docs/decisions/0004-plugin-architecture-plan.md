...
- Providers can request dynamic tab handles. Profiles, Calc, Run, Sinks, Proc, and Sessions use this
...
- Profiles, Calc, Run, Sinks, Proc, and Sessions now use dynamic tab handles. Other existing provider
...
- Profiles, Calc, Run, Sinks, Proc, and Sessions no longer have static `TAB_*` enum values and register
