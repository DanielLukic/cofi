...
- Providers can request dynamic tab handles. Profiles, Calc, Run, Sinks, Proc, Sessions, Apps, Names, Rules, Config, and Hotkeys use this
...
- Profiles, Calc, Run, Sinks, Proc, Sessions, Apps, Names, Rules, Config, and Hotkeys now use dynamic tab handles. Other existing provider
...
- Profiles, Calc, Run, Sinks, Proc, Sessions, Apps, Names, Rules, Config, and Hotkeys no longer have static `TAB_*` enum values and register
