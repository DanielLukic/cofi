...
- Providers can request dynamic tab handles. Profiles, Calc, Run, and Sinks use this
...
- Profiles, Calc, Run, and Sinks now use dynamic tab handles. Other existing provider
...
- Profiles, Calc, Run, and Sinks no longer have static `TAB_*` enum values and register
