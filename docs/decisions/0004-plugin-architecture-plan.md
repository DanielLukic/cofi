...
- Providers can request dynamic tab handles. Profiles, Calc, Run, Sinks, and Proc use this
...
- Profiles, Calc, Run, Sinks, and Proc now use dynamic tab handles. Other existing provider
...
- Profiles, Calc, Run, Sinks, and Proc no longer have static `TAB_*` enum values and register
