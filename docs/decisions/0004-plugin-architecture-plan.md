...
- Providers can request dynamic tab handles. Profiles, Calc, Run, Sinks, Proc, Sessions, and Apps use this
...
- Profiles, Calc, Run, Sinks, Proc, Sessions, and Apps now use dynamic tab handles. Other existing provider
...
- Profiles, Calc, Run, Sinks, Proc, Sessions, and Apps no longer have static `TAB_*` enum values and register
