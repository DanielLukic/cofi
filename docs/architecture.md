...
- **Dynamic tab handles** — provider tabs can request `COFI_PROVIDER_DYNAMIC_TAB` and receive a runtime tab handle. Profiles, Calc, Run, and Sinks use this path; older providers still use legacy `TAB_*` handles during migration.
