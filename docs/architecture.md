...
The project is indexed by GitNexus (5,887 symbols, 12,294 relationships, 221 execution flows). See [CLAUDE.md → GitNexus](../CLAUDE.md#gitnexus--code-intelligence) for the impact-analysis and rename workflows.
